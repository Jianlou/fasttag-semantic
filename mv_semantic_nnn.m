...
[MultiM, vFeature, indx, normP, trteindx] = mutiview_feature_learning_nnn(xTr, yTr, xTe, ParaM1,tagV);
name = [num2str(par) 'se_multiview_learning12.mat'];
save(name,'MultiM', 'vFeature', 'indx', 'normP','trteindx');
% load('0se_multiview_learning12.mat');
