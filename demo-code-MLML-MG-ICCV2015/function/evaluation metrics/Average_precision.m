function [Average_Precision, aveprec]=Average_precision(Outputs,test_target)
...
%         ap_binary(i)=summary/Label_size(i);
        aveprec(i)=summary/Label_size(i);
    end
else
     for i=1:num_instance
        temp=Outputs(:,i);
    ...
    Average_Precision=mean(aveprec);
