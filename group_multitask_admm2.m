function [ W ,b] = group_multitask_admm2(X, Y, lambda, lambda2, Idx)
...
while true
 ...
 W = (Sxy - Q + MU*Z)/(Sx + lambda2*I + MU*I);
 ...
 if mod(iteration,8)==0
     ...
     orig_loss = 0.5*fit_loss^2 + lambda*strct_loss + 0.5*lambda2*norm(W,'fro')^2;
